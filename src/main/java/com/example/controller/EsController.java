...
import com.example.page.EsPage;
...
//        jsonObject.put("id", DateUtil.formatDate(new Date()));
        ...
        IndexResponse response = transportClient
                .prepareIndex(indexName, esType, jsonObject.getString("id")).setSource(jsonObject).get();
...
//            Map<String, Object> map = ElasticsearchUtil.searchDataById(indexName, esType, id, null);
            GetRequestBuilder getRequestBuilder = transportClient.prepareGet(indexName, esType, "111");
